...
##### 6. Возможность настройки аккаунта пользователя:

6.1. Возможность добавления и изменения фотографии профиля.

6.2. Возможность изменения отображаемого имени профиля.

6.3. Возможность добавления и изменения краткой биографии пользователя, отображаемой в профиле.

6.4. Возможность изменения пароля от аккаунта пользователя.
